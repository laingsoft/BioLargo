...
import os
from .pasteur_private.settings_secret import *
...
ALLOWED_HOSTS = ['192.168.1.8', '192.168.1.9', '192.168.1.11', '192.168.1.12', '0.0.0.0', 'localhost', 'pasteur.io','208.75.74.213', '192.168.1.25', '192.168.99.100', 'web']
